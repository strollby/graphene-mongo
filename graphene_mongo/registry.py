...
class Registry:
    ...
    def register(self, cls):
        ...
        """
        from graphene_mongo.asynchronous.types import AsyncGrapheneMongoengineObjectTypes
        from graphene_mongo.synchronous.types import GrapheneMongoengineObjectTypes
